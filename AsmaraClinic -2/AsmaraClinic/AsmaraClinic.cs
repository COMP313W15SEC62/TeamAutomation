...
{
    public partial class AsmaraClinic : Form
    {
        ...
        private void btnAddAppointment_Click_1(object sender, EventArgs e)
        {
            ...
            values('" + int.Parse(txtAppointmentID.Text.Trim()) + "', '" + int.Parse(cmbPatientID2.Text.Trim()) + "', '" + int.Parse(txtStaffID3.Text.Trim()) + "', '" + int.Parse(txtTimeSlotID.Text.Trim()) + "', 'Active')";
        ...
        private void btnViewAppointment_Click_1(object sender, EventArgs e)
        {
            ...
            while (rd.Read())
            {
                ...
                txtAppointmentID.Text = appoId; cmbPatientID2.Text = paId; txtStaffID3.Text = staId; txtTimeSlotID.Text = tiId; cmbStatus.Text = stat;
        ...
        private void btnUpdateAppointment_Click_1(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                String st = "update Appointment set AppointmentID='" + int.Parse(txtAppointmentID.Text.Trim()) + "', PatientID= '" + int.Parse(cmbPatientID2.Text.Trim()) + "', StaffID= '" + int.Parse(txtStaffID3.Text.Trim()) + "',  TimeSlotID= '" + int.Parse(txtTimeSlotID.Text.Trim()) + "', Status='" + cmbStatus.Text.Trim() + "' Where AppointmentID= '" + int.Parse(txtAppointmentID.Text.Trim()) + "' ";
                SqlCommand com = new SqlCommand(st, con);
        ...
        {
            txtAppointmentID.Clear(); cmbPatientID2.Text = ""; txtStaffID3.Clear(); txtTimeSlotID.Clear(); cmbStatus.Text = "";
        }
       ...
       private void btnTimeSlotView_Click(object sender, EventArgs e)
       {
           sqlDataAdapter7.Fill(dataSet81);
       }
       ...
       private void cmbPatientID2_SelectedIndexChanged(object sender, EventArgs e)
       {
